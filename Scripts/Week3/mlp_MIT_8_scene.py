...
from keras.layers import Flatten, Dense, Reshape, Dropout, Conv2D, MaxPooling2D
...
file_model=load_model(MODEL_FNAME)
...
#print("This is the layer output")
#print(model.get_layer('third').output)
